...
<style>
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  header svg { height: 10px; width: auto; }
  main {
    max-width: 720px;
    margin: 56px auto;
    padding: 0 24px;
...
<body>
<header>
  <div style="height:10px;display:flex;align-items:center">__LOGO__</div>
</header>
<main>
...
<style>
  ...
  *, *::before, *::after {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  header img {{ height: 10px; }} header svg {{ height: 10px; width: auto; }}
